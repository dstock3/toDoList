...
const taskButtons = (set) => {
    const topButtonDiv = (0,_elements__WEBPACK_IMPORTED_MODULE_0__.elementBuilder)("div", "top-button-div", set.projectElement)
      ...
      if (set.project.taskArray.length > 0) {
        ...
        function minProject() {
          ...
          minButton.addEventListener("click", function() {
            ...
            _elements__WEBPACK_IMPORTED_MODULE_0__.projectDiv.insertBefore(maxProject.projectElement, _elements__WEBPACK_IMPORTED_MODULE_0__.projectDiv.children[projectIndex]);
    ...
    const sortByDueDateButton = (() => {
      if (set.project.taskArray.length > 1) {
        ...
        function newSortedList() {
          ...
          _elements__WEBPACK_IMPORTED_MODULE_0__.projectDiv.insertBefore(sortedProject.projectElement, _elements__WEBPACK_IMPORTED_MODULE_0__.projectDiv.children[projectIndex]);
  ...
  const taskPrompt = (() => {
    ...
    function createTask() {
      ...
      if (isValid) {
        ...
        let newTask = (0,_objectBuilder__WEBPACK_IMPORTED_MODULE_0__.toDo)(title, project, description, enteredDate, dueDate, priority, notes, status);
