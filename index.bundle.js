...
const start = (() => {
  ...
  if (typeof allProjects.projectList[0] == 'undefined') {
    ...
    for (let i = 0; i < fetchedList.length; i++) {
      const newProjSet = (0,_modules_projectCreator__WEBPACK_IMPORTED_MODULE_2__.projectBuilder)(fetchedList[i]);
...
/* harmony export */   "allProjects": () => (/* reexport safe */ _index__WEBPACK_IMPORTED_MODULE_0__.allProjects),
