  ...
  const taskPrompt = (() => {
    ...
    function createTask() {
      ...
      if (isValid) {
        ...
        let updatedProject = (0,_taskElements__WEBPACK_IMPORTED_MODULE_2__.projectBuilder)(project);
