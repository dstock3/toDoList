...
const taskButtons = (set) => {
  ...
  const warningMessage = () => {
    ...
    let container = (0,_elements__WEBPACK_IMPORTED_MODULE_0__.elementBuilder)("div", "warning-buttons", warningElement)
