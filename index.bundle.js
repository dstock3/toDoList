...
const viewButton = (() => {
  function maxView() {
    console.log(_elements__WEBPACK_IMPORTED_MODULE_1__.projectDiv.children)
    changeView.maxAll();
