...
const getTheme = () => {
    ...
    if (themePair !== undefined) {
        (0,_sidebar__WEBPACK_IMPORTED_MODULE_0__.setTheme)(themePair[0], themePair[1])
    };
};
