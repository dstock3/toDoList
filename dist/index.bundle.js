...
/* harmony export */   "deadlineCheck": () => (/* binding */ deadlineCheck)
/* harmony export */ });
...
function formatDate(enteredDate) {
    ...
    let formattedDate = (0,date_fns__WEBPACK_IMPORTED_MODULE_2__.default)(dueDate, 'EEEE, MMMM do, yyyy');
    return formattedDate
}

function today() {
    let today = new Date();
    today = (0,date_fns__WEBPACK_IMPORTED_MODULE_2__.default)(today, 'EEEE, MMMM do, yyyy')
...
function deadline(dueDate) {
    ...
    let daysTill = (0,date_fns__WEBPACK_IMPORTED_MODULE_3__.default)(dropDead, today)
...
function sortByDueDate(tasks) {
    ...
    let sortedArray = deadlineArray.sort(date_fns__WEBPACK_IMPORTED_MODULE_4__.default);
    let sortedTasks = [];
...
function notifCheck(task) {
  ...
  let notif = (0,_date__WEBPACK_IMPORTED_MODULE_2__.deadlineCheck)(deadlineMessage);
...
function toDoBuilder(task, parent) {
  ...
  let dueMessage = (0,_elements__WEBPACK_IMPORTED_MODULE_1__.elementBuilder)("p", "due-message", taskDiv);
