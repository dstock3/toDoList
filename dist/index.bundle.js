...
__webpack_require__.r(__webpack_exports__);
/* harmony export */ __webpack_require__.d(__webpack_exports__, {
/* harmony export */   "projectHeader": () => (/* reexport safe */ _taskElements__WEBPACK_IMPORTED_MODULE_2__.projectHeader),
/* harmony export */   "projectBuilder": () => (/* reexport safe */ _taskElements__WEBPACK_IMPORTED_MODULE_2__.projectBuilder),
/* harmony export */   "allProjects": () => (/* binding */ allProjects),
/* harmony export */   "addTask": () => (/* binding */ addTask),
/* harmony export */   "addProject": () => (/* binding */ addProject)
/* harmony export */ });
/* harmony import */ var _objectBuilder__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./objectBuilder */ "./src/modules/objectBuilder.js");
/* harmony import */ var _elements__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ./elements */ "./src/modules/elements.js");
/* harmony import */ var _taskElements__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ./taskElements */ "./src/modules/taskElements.js");
/* harmony import */ var _buttons__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! ./buttons */ "./src/modules/buttons.js");
/* harmony import */ var _sidebar__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(/*! ./sidebar */ "./src/modules/sidebar.js");
/* harmony import */ var _validation__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(/*! ./validation */ "./src/modules/validation.js");
...
let allProjects = (0,_objectBuilder__WEBPACK_IMPORTED_MODULE_0__.projectTracker)();
...
const addTask = (set) => {
  ...
  const taskPrompt = (() => {
    ...
    (0,_buttons__WEBPACK_IMPORTED_MODULE_3__.addTransparent)(children);
    ...
    function exit() {
      (0,_buttons__WEBPACK_IMPORTED_MODULE_3__.removeTransparent)(children);
      prompt.remove();
    }
    ...
    function createTask() {
      ...
      let validArray = (0,_validation__WEBPACK_IMPORTED_MODULE_5__.validation)(obj);
      let isValid = validArray[0];

      if (isValid) {
        let dueDate = validArray[1];
        let newTask = (0,_objectBuilder__WEBPACK_IMPORTED_MODULE_0__.toDo)(
          title,
          project,
          description,
          enteredDate,
        ...
        (0,_storage__WEBPACK_IMPORTED_MODULE_6__.store)(newTask);
        (0,_sidebar__WEBPACK_IMPORTED_MODULE_4__.notif)(newTask);
        (0,_taskElements__WEBPACK_IMPORTED_MODULE_2__.taskBuilder)(newTask, projectElement);

        let projectIndex = (0,_elements__WEBPACK_IMPORTED_MODULE_1__.getPosition)(projectElement);
        projectElement.remove();
        let updatedProject = (0,_taskElements__WEBPACK_IMPORTED_MODULE_2__.projectBuilder)(set.project);

        allProjects.masterList.push(updatedProject);
        _elements__WEBPACK_IMPORTED_MODULE_1__.projectDiv.insertBefore(
          updatedProject.projectElement,
          _elements__WEBPACK_IMPORTED_MODULE_1__.projectDiv.children[projectIndex]
        );
        (0,_buttons__WEBPACK_IMPORTED_MODULE_3__.taskButtons)(updatedProject);
...
const addProject = () => {
  const projectPrompt = (() => {
    ...
    function createProject() {
      ...
      let isValid = (0,_validation__WEBPACK_IMPORTED_MODULE_5__.validateProj)(obj);

      if (isValid) {
        let newProject = (0,_objectBuilder__WEBPACK_IMPORTED_MODULE_0__.project)(title, description, []);
        let projectSet = (0,_taskElements__WEBPACK_IMPORTED_MODULE_2__.projectBuilder)(newProject);
        (0,_buttons__WEBPACK_IMPORTED_MODULE_3__.taskButtons)(projectSet);
...
__webpack_require__.r(__webpack_exports__);
/* harmony export */ __webpack_require__.d(__webpack_exports__, {
/* harmony export */   "allProjects": () => (/* reexport safe */ _modules_projectCreator__WEBPACK_IMPORTED_MODULE_2__.allProjects)
/* harmony export */ });
...
const start = (() => {
  ...
  if (newTask !== null) {
    ...
    (0,_modules_sidebar__WEBPACK_IMPORTED_MODULE_4__.notif)(newTask);
    projObj.taskArray.push(newTask)
    const newProject = (0,_modules_objectBuilder__WEBPACK_IMPORTED_MODULE_1__.project)(
      projObj.title,
      projObj.description,
      projObj.taskArray
    )
    const newProjSet = (0,_modules_projectCreator__WEBPACK_IMPORTED_MODULE_2__.projectBuilder)(newProject);
    _modules_projectCreator__WEBPACK_IMPORTED_MODULE_2__.allProjects.masterList.push(newProjSet);
    (0,_modules_buttons__WEBPACK_IMPORTED_MODULE_3__.applyButtons)(_modules_projectCreator__WEBPACK_IMPORTED_MODULE_2__.allProjects.masterList);
  ...
  if (newTask === null) {
    const defaultProject = (0,_modules_objectBuilder__WEBPACK_IMPORTED_MODULE_1__.project)(
      "New Project",
      "Add a task below and start tracking your project!",
      []
    );
    const defaultProjectSet = (0,_modules_projectCreator__WEBPACK_IMPORTED_MODULE_2__.projectBuilder)(defaultProject);
    _modules_projectCreator__WEBPACK_IMPORTED_MODULE_2__.allProjects.masterList.push(defaultProjectSet);
    (0,_modules_buttons__WEBPACK_IMPORTED_MODULE_3__.applyButtons)(_modules_projectCreator__WEBPACK_IMPORTED_MODULE_2__.allProjects.masterList);
  }
  return { allProjects: _modules_projectCreator__WEBPACK_IMPORTED_MODULE_2__.allProjects };
})();
