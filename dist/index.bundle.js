...
const addTask = (set) => {
  ...
  const taskPrompt = (() => {
    ...
    let theme = _sidebar__WEBPACK_IMPORTED_MODULE_5__.sidebar.element.id;
    if (theme !== undefined) {
      prompt.id = theme;
