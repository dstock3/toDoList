    ...
    for (let i = 0; i < notifs.length; i++) {
        ...
        if (notif.parentNode.children.length === 1) {
            ...
            function removeNotif() {
                ...
                button.remove();
                if (notifs.length === 0) {
                    const noNotif = (0,_elements__WEBPACK_IMPORTED_MODULE_0__.elementBuilder)("p", "notif", sidebar.notifContainer);
                    noNotif.id = "no-notif"
