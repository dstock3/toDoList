    ...
    for (let i = 0; i < allProjects.masterList.length; i++) {
      ...
      if (set.project.taskArray.length > 0) {
        ...
        viewElement.addEventListener("click", function () {
          ...
          (0,_buttons__WEBPACK_IMPORTED_MODULE_3__.taskButtons)(maxProject);
        });
      }
    }
  }
...
const start = (() => {
  const defaultProject = (0,_modules_objectBuilder__WEBPACK_IMPORTED_MODULE_1__.project)("New Project", "Add a task below and start tracking your project!", []);
