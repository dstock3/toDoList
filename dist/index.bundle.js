...
const start = (() => {
  ...
  if (fetchedList.length === 0) {
    ...
    (0,_modules_store__WEBPACK_IMPORTED_MODULE_6__.getTheme)()
  } else {
    for (let i = 0; i < fetchedList.length; i++) {
      ...
      for (let y = 0; y < tasks.length; y++) {
        (0,_modules_sidebar__WEBPACK_IMPORTED_MODULE_5__.notif)(tasks[y]);
      }
